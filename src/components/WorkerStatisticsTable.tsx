              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50/60">
                    ...
                    <TableHead className="text-right">{t('statistics.period')}</TableHead>
                    <TableHead className="text-right">{t('statistics.total')}</TableHead>
                    <TableHead className="text-right">{t('statistics.remaining')}</TableHead>
                    <TableHead className="text-right">{t('statistics.progress')}</TableHead>
                    <TableHead className="text-right">
                      <div className="flex items-center justify-end gap-1">
                        <Clock className="h-3.5 w-3.5" />
                        <span>{t('statistics.days')}</span>
                      </div>
                    </TableHead>
                    <TableHead className="text-center">{t('statistics.actions')}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {workers.map(worker => {
                            ...
                            <HoverCard>
                              <HoverCardTrigger asChild>
                                <div className="inline-flex items-center gap-1 cursor-help hover:text-blue-600 transition-colors">
                                  ...
                                  <span className="text-xs text-gray-500">{t('statistics.total')}</span>
                                </div>
                              </HoverCardTrigger>
                              <HoverCardContent className="w-52" align="end">
                                <div className="space-y-2">
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm text-gray-600">{t('statistics.normal')}</span>
                                    <span className="font-mono text-sm">{stats.normalDays}</span>
                                  </div>
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm text-gray-600">{t('statistics.weekend')}</span>
                                    <span className="font-mono text-sm">{stats.weekendDays}</span>
                                  </div>
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm text-gray-600">{t('statistics.holiday')}</span>
