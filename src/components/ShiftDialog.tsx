...
export function ShiftDialog({ 
  ...
  const onSubmit = async () => {
    try {
      ...
      let endDate;
      if (isLeaveType(shiftData.shiftType as ShiftType) && shiftData.endDate) {
      ...
      const formData = {
        ...
        hoursWorked: isLeaveType(shiftData.shiftType as ShiftType) ? null : parseFloat(shiftData.hoursWorked) || 0,
        location: isLeaveType(shiftData.shiftType as ShiftType) ? null : shiftData.location || null
      };
