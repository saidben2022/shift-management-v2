...
export const getWorkerPeriodMaxHours = async (workerId, periodStart, periodEnd) => {
    try {
        ...
        const response = await api.get('/api/worker-period-hours', {
            params: {
                workerId,
                periodStart: formattedStart,
                periodEnd: formattedEnd
...
export const useWorkerPeriodHours = (workerId, periodStart, periodEnd) => {
    ...
    const mutation = useMutation({
        mutationFn: async (data) => {
            try {
                ...
                const response = await api.post('/api/worker-period-hours', requestData);
    ...
    const setWorkerPeriodHours = async (data) => {
        try {
